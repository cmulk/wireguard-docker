...
There are currently 2 branches, __stretch__ and __buster__. Use the branch that corresponds to your host machine if the kernel module install feature is going to be used. _Note that the stretch version currently does not work with kernel 4.9.0-9 on the host system due to a bug in that kernel version. Please use 4.9.0-8 instead.
